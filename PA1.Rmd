...
##### The mean of total number of steps per day is `r mean_total_steps`
##### The median of total number of steps per day is `r median_total_steps`
...
##### The 5-minute interval that contains the maximum number of steps on average across all days is `r max_avg_steps_interval`
...
##### The mean of total number of steps per day of the imputed data is `r mean_total_steps_imp`. The mean remained the same as before.
##### The median of total number of steps per day of the imputed data is `r median_total_steps_imp`. The median increased when compared to the dataset without the imputed data.
